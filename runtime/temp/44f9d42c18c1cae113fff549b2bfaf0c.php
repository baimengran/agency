<?php /*a:1:{s:74:"D:\phpstudy_pro\WWW\www.agency.com\application\index\view\my\dl_mymsg.html";i:1567906686;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<div class="webbox" id="webbox">
			...
			<div class="table_d">
				...
				<table class="list_t"as border="1" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>姓名</td>
						<td><?php echo htmlentities($user['real_name']); ?></td>
					</tr>
					<tr>
						<td>代理等级</td>
					...
					<tr>
						<td>微信号</td>
						<td><?php echo htmlentities($user['wechatid']); ?></td>
					</tr>
					<tr>
						<td>手机号码</td>
					...
					<tr>
						<td>货物总数量</td>
						<td><?php echo htmlentities($user['num']); ?></td>
					</tr>
					<tr>
						<td>代理状态</td>
					...
					<tr>
						<td>审核日期</td>
						<td><?php echo htmlentities($user['status_time']); ?></td>
					</tr>
					<tr>
						<td>注册日期</td>
