<?php /*a:1:{s:76:"D:\phpstudy_pro\WWW\www.agency.com\application\index\view\cart\order_tj.html";i:1568972301;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
					...
					<div id="wrap" class="wrap disflex">
						...
						<div class="address boxsiz" @click="selecadd">
							<div class="add_l">
								...
								<div class="al_1"><?php echo htmlentities($address['name']); ?> <span class="l_tel" ><?php echo htmlentities($address['phone']); ?></span></div>
								<div class="al_2 oh1" id="address">
									<?php echo htmlentities($address['address']); ?>
									<input type="hidden" id="address_id" value="<?php echo htmlentities($address['id']); ?>">
								</div>
								<?php else: ?>
								 <div>请先添加地址</div>
								<?php endif; ?>
						...
						<div class="goodslist mb10">
							...
							<div class="gone disflex boxsiz">
								...
								<div class="goodsmsg disflex">
									...
									<div class="fz14 c6">
										<span><?php echo htmlentities($v['price']); ?> 元</span>
										<input type="hidden" class="ids" name="ids[]" value="<?php echo htmlentities($v['p_id']); ?>">
									</div>
								</div>
						...
						<div class="guige">
							...
							<div class="fz14 c9">
								运费：￥<?php echo htmlentities($site['yunfei']); ?>
							</div>
						</div>
						<div class="guige">
							<div class="guige_l">
							...
							<div class="fz14 c9">
								优惠：￥<?php echo htmlentities($site['youhui']); ?>
							</div>
						</div>
						<div class="fixbottom">
							<div class="fb_l">合计:￥<?php echo htmlentities($total_price); ?></div>
			...
			var Vindex = new Vue({
				...
				methods: {
					subbtn() {
						...
						let ids=[];
						let total_price = "<?php echo htmlentities($total_price); ?>";
                        $('.ids').each(function(i){
                            ids[i]=($(this).val());
                        });
						...
						if (address == '' || address == undefined) {
							...
							$.ajax({
								type: "post",
								url: "<?php echo url('cart/order_add'); ?>",
